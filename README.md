...
# Todo-App
Todo App is an app built with React, that allows users input daily task and update them too.
...
> Run this command `https://github.com/Othniel2471/math-magician.git`
